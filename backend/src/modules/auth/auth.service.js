...
//     for (const [key, value] of Object.entries(requiredFields)) {
//         if (!value?.trim()) {
//             cleanUp(`Missing required field: ${key}`);
//             throw new ApiError(400, `${key} is required`);
//         }
//     }
...
//         throw new ApiError(
//             400,
//             `Password is invalid: ${passwordError.errors.join(", ")}`
//         );
//     }
...
//             throw new ApiError(
//                 409,
//                 "This email is registered via Google. Please continue with Google or set up a password to enable email sign-in."
//             );
//         }
