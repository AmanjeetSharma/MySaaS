    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col justify-between antialiased selection:bg-primary selection:text-primary-foreground">
            ...
            <main className="max-w-xl mx-auto px-4 py-16 flex-1 flex items-center justify-center w-full">
                <div className="bg-card rounded-2xl border border-border/80 shadow-xs p-8 text-center space-y-6 w-full text-card-foreground">
                    ...
                    <div className="bg-muted/30 rounded-xl p-5 border border-border/80 text-left space-y-3 text-xs">
                    ...
                    <button
                        ...
                        className="w-full py-3 px-4 rounded-xl bg-primary text-primary-foreground font-semibold text-sm hover:bg-primary/90 transition-all cursor-pointer shadow-xs"
                    >
